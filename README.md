...
*   `course_image_making.py`: Matplotlib을 사용하여 시뮬레이터의 배경으로 사용할 수 있는 시험장 코스 이미지를 생성하는 스크립트입니다. 생성된 이미지를 저장하여 시뮬레이터에서 불러올 수 있습니다.
...
*   **배경 이미지 조정**:
    ...
    *   python course_image_making.py 으로 만들어진 이미지의 X/Y offset은 -27, -11, 스케일(배율)은 105~106 이 적당해 보입니다. 
